...
def train_and_evaluate(filename_list, model_name,train_ratio, timesteps = 20, feature_num = 8, epoches = 3):
    ...
    model.add(Conv2D(48, (3, 3), activation='relu', input_shape=(dim_x, dim_y, 1)))
...
def main():
    ...
    train_and_evaluate(filename_list, model_name = 'cnn_rnn_1.h5',train_ratio = 0.7)
