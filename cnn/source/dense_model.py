...
def train_and_evaluate(filename_list, model_name,train_ratio, timesteps = 20, feature_num = 8):
    ...
    model.add(Dense(100, activation='relu', input_shape=(timesteps*feature_num, )))
    model.add(Dense(240,kernel_regularizer=regularizers.l2(0.01), activity_regularizer=regularizers.l1(0.01)))
    model.add(Dropout(0.5))
    #model.add(Dense(100,activation = 'relu', kernel_regularizer=regularizers.l2(0.01)))
    model.add(Dense(80, activation = 'relu', kernel_regularizer=regularizers.l2(0.01), activity_regularizer=regularizers.l1(0.01)))
...
def main():
    ...
    train_and_evaluate(filename_list, model_name = 'one_feature.h5',train_ratio = 0.7)
