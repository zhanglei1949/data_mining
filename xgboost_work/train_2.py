...
def main():
    filename = '../data/generated/data_0_9_standard_scaler.csv'
    testfilename = '../data/generated/data_10_19_standard_scaler.csv'
    train_ratio = 0.7
    vali_split = 0.8
    x_train, y_train, not_use1, not_use2 = load_data(filename,train_ratio = 0.8)
    not_use1, not_use2, x_test, y_test = load_data(testfilename, train_ratio = 0.5)
